...
### Hardened Dockerfile: [python:3.11-alpine] [emindsguardians/python:3.11-alpine-hard]
...
### Dockerfile: Python (Hardened image with /home/eminds)

```bash
FROM python:3.11-alpine AS twinarc
WORKDIR /home/eminds/app
ADD source-code /home/eminds/app
RUN pip3.11 install -r requirements.txt
RUN apk add --no-cache binutils
RUN pyinstaller main.spec
RUN chmod +x dist/main && chown -R 1001:1001 dist/main

FROM  emindsguardians/python:3.11-alpine-hard
WORKDIR /home/eminds
COPY --from=twinarc /home/eminds/app/dist/main /home/eminds
```
